...
const form_hb = document.getElementById("input-hb");
...
// const input_besi = document.getElementById("besi");
// const input_vitC = document.getElementById("vitC");
const input_cafein = document.getElementById("cafein");
// const form_mens = document.getElementById("input-mens")
const input_mens = document.getElementById("mens");
const input_donor = document.getElementById("donor");
const input_heavyPhysic = document.getElementById("fisik");
